...
gsap.set("#ctaWrapper", { opacity: 0, x: 150 });
gsap.set("#fcWrapper", { opacity: 0 });
  gsap.set("#curveWrapper", { x: -445 });
...
function animate() {
    ...
    if (defaultValues.frame1Headline.toLowerCase() != "n/a") {
        tl.to("#frame1-headline1", 1, { opacity: 1, x: 0, ease: "startAnimation", force3D: true }, "-=0.3")
        ...
        tl.to("#ctaWrapper", 1, { opacity: 1, x: 0, ease: "startAnimation", force3D: true, onComplete: getEnd, onCompleteParams: ["frame1"] }, "-=0.8")
            ...
            .to("#arrow", 0.2, { x: 0, ease: "arrowEaseIn", force3D: true, onComplete: getEnd, onCompleteParams: ["frame1end"]})
    }
    //frame 2
    if (defaultValues.frame2Headline.toLowerCase() != "n/a") {
        ...
        if (defaultValues.frame1Headline2.toLowerCase() != "n/a") {
            tl.to("#frame1-headline2", 1, { opacity: 0, x: 150, ease: "endAnimation", force3D: true }, "-=0.8")
        }
        if (defaultValues.frame1Headline3.toLowerCase() != "n/a") {
            tl.to("#frame1-headline3", 1, { opacity: 0, x: 150, ease: "endAnimation", force3D: true }, "-=0.8")
        }

        tl.to("#frame2-headline1", 1, { opacity: 1, x: 0, ease: "startAnimation", force3D: true })
        ...
        if (defaultValues.ctaText2.toLowerCase() != "n/a") {
            tl.to("#arrow", 0.2, { opacity: 0, x: 5, ease: "arrowEaseIn", force3D: true }, "+=1")
                .to("#fcArrow", 0.2, { opacity: 1, x: 5, ease: "arrowEaseIn", force3D: true }, "-=0.1")
                .to("#fcArrow", 0.2, { x: 0, opacity: 1, ease: "arrowEaseIn", force3D: true })
                .to("#fcArrow", 0.2, { x: 5, ease: "arrowEaseIn", force3D: true })
                .to("#fcArrow", 0.2, { x: 0, ease: "arrowEaseIn", force3D: true, onComplete: takeScreenshot })
                .to("#arrow", 0.2, { opacity: 0, x: 5, ease: "arrowEaseIn", force3D: true }, "+=1.5")
                .to("#arrow", 0.2, { opacity: 1, x: 5, ease: "arrowEaseIn", force3D: true, onComplete: getEnd, onCompleteParams: ["frame2end"] }, "-=0.1")
        } else {
            tl.to("#arrow", 0.2, { x: 5, ease: "arrowEaseIn", force3D: true }, "+=1");
        }
        tl.to("#arrow", 0.2, { x: 0, ease: "arrowEaseIn", force3D: true })
            .to("#arrow", 0.2, { x: 5, ease: "arrowEaseIn", force3D: true })
            .to("#arrow", 0.2, { x: 0, ease: "arrowEaseIn", force3D: true, onComplete: getEnd, onCompleteParams: ["frame2end"]  })
    }
    //start frame 3
    if (defaultValues.frame3Headline.toLowerCase() != "n/a") {
        //end frame 2
        if (defaultValues.frame2Headline.toLowerCase() != "n/a") {
            tl.to("#frame2-headline1", 1, { opacity: 0, x: 150, ease: "endAnimation", force3D: true }, "+=2.5")
        }
        if (defaultValues.frame2Headline2.toLowerCase() != "n/a") {
            tl.to("#frame2-headline2", 1, { opacity: 0, x: 150, ease: "endAnimation", force3D: true }, "-=0.8")
        }
        if (defaultValues.frame2Headline3.toLowerCase() != "n/a") {
            tl.to("#frame2-headline3", 1, { opacity: 0, x: 150, ease: "endAnimation", force3D: true }, "-=0.8")
        }

        tl.to("#frame3-headline1", 1, { opacity: 1, x: 0, ease: "startAnimation", force3D: true })
        ...
        tl.to("#arrow", 0.2, { x: 5, ease: "arrowEaseIn", force3D: true }, "+=1")
            .to("#arrow", 0.2, { x: 0, ease: "arrowEaseIn", force3D: true })
            .to("#arrow", 0.2, { x: 5, ease: "arrowEaseIn", force3D: true })
            .to("#arrow", 0.2, { x: 0, ease: "arrowEaseIn", force3D: true, onComplete: getEnd, onCompleteParams: ["frame3"] })
        //end frame 3
        if (defaultValues.frame3Headline.toLowerCase() != "n/a") {
            tl.to("#frame3-headline1", 1, { opacity: 0, x: 150, ease: "endAnimation", force3D: true }, "+=2.5")
        }
        if (defaultValues.frame2Headline2.toLowerCase() != "n/a") {
            tl.to("#frame3-headline2", 1, { opacity: 0, x: 150, ease: "endAnimation", force3D: true }, "-=0.8")
        }
        if (defaultValues.frame2Headline3.toLowerCase() != "n/a") {
            tl.to("#frame3-headline3", 1, { opacity: 0, x: 150, ease: "endAnimation", force3D: true }, "-=0.8")
        }
    }
}
