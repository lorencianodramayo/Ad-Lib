...
var defaultValues = {
    ...
    frame1Background: "curve_728x90.png",
    currency: "N/A",
    ...
    cssAttrib: "#frame1-headline2{margin: 1px 0 1px 0;}",
    bgColor: "White",
    landingPage: "https://www.google.com",
    videoUrl: "315x90_Video_Gracie_01.mp4",
    imageTags: "315x90_Video_Gracie_01.mp4",
    startDate: " ",
    endDate: " ",
    readableLabel: " ",
}
...
let llogoImg = document.querySelector("#logoImg"),
    ...
    textCTA = document.querySelector("#textCTA"),
...
function populate() {
    ...
    //---cta color
    textCTA.style.color = colorPalette[ctaColor1];
    //---font size
    for (let i = 1; i <= 3; i++) {
