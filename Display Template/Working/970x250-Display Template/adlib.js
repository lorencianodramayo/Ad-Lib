...
var defaultValues = {
    ...
    frame1Background: "curve_970x250.png",
    currency: "N/A",
    ...
    cssAttrib: "#frame1-headline1{margin-top:33px;}#frame1-headline2{margin: 9px 0 33px 0;}",
    bgColor: "White",
    landingPage: "https://www.google.com",
    videoUrl: "460x250_Video_Gracie_01.mp4",
    imageTags: "460x250_Video_Gracie_01.mp4",
    startDate: " ",
    endDate: " ",
    readableLabel: " ",
}
...
let llogoImg = document.querySelector("#logoImg"),
    ...
    finalcallHandler = document.querySelector("#fcWrapper"),
    ctaHandler = document.querySelector("#ctaWrapper"),
