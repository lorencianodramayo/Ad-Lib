...
gsap.set(".text-class", { opacity: 0, x: 100 });
gsap.set("#ctaWrapper", { opacity: 0, x: 200 });
gsap.set("#fcWrapper", { opacity: 0 });

function animate() {
    const staticHeight = (document.querySelector("#copyWrapper").offsetHeight - document.querySelector("#container").offsetHeight);
    gsap.set("#curveWrapper", { y: staticHeight });
    adlibStart();
    callGWDPlayPause();
    tl.play()
        .to("#logoWrapper", 0, { opacity: 1 })
        .to(["#backgroundWrapper", "#gradiantWrapper"], 1, { opacity: 1,ease: "startAnimation", force3D: true })
        .to(["#curveWrapper"], 1, { y: 0, ease: "startAnimation", force3D: true }, "-=1")
    //start frame 1
    ...
    if (defaultValues.frame2Headline.toLowerCase() != "n/a") {
        tl.to("#frame2-headline1", 1, { opacity: 1, x: 0, ease: "startAnimation", force3D: true }, "-=0.3")
    ...
    if (defaultValues.frame3Headline.toLowerCase() != "n/a") {
        tl.to("#frame3-headline1", 1, { opacity: 1, x: 0, ease: "startAnimation", force3D: true }, "-=0.3")
    ...
    tl.to(["#ctaWrapper", "#fcWrapper"], 1, { opacity: 0, x: -100, ease: "endAnimation", force3D: true, onStart: takeScreenshot }, "-=0.8")
        .to(["#backgroundWrapper", "#gradiantWrapper"], 1, {opacity:0, ease: "endAnimation", force3D: true,}, "-=1")
        .to("#curveWrapper", 1, { y: staticHeight, ease: "endAnimation", force3D: true,onComplete: ()=> _loopCount++}, "-=1")
}
